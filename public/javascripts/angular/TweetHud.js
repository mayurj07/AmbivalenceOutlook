...
app.controller('TweetHud', function($scope, $resource, $timeout, $rootScope, PubNub) {

	var TWEET_SAMPLE_SIZE = 25; // The number of Tweet to display in the left-hand column
